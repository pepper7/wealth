<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<link rel="shortcut icon" href="${pageContext.request.contextPath}/images/icon_logo_16x16.png"/>
<!-- <link href="${pageContext.request.contextPath}/images/js/theme/redmond/jquery.ui.all.css" rel="stylesheet" type="text/css"/> -->
...
<script type="text/javascript" src="${pageContext.request.contextPath}/images/js/jquery-1.7.2.js" charset="UTF-8"></script>
<!-- <script type="text/javascript" src="${pageContext.request.contextPath}/images/js/jquery-ui-1.8.14.custom.min.js"></script> -->
<script type="text/javascript" src="${pageContext.request.contextPath}/images/js/bootstrap.min.js" charset="UTF-8"></script>
